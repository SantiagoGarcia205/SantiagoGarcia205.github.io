...
document.querySelectorAll('.btn, .social-links a, .contact-item, .project-card').forEach(el => {
...
console.log('%chttps://github.com/SantiagoGarcia205', 'font-size: 12px; color: #2563eb;');
